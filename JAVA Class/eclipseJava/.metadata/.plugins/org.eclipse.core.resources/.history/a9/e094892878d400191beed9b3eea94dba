...
public class DigitsMatching {
	...
	public static void main(String[] args) {
		...
		pat = Pattern.compile("(0?[1-9]|[12][0-9]|3[01])\\W\\w{3}\\W\\d{2,4}");
		mat = pat.matcher("41-Jan-96"); // for date of birth or hire dates
		System.out.println(mat.matches());
		
		pat = Pattern.compile("[1-9]|1[0-9]|2[0-9]");
		mat = pat.matcher("20"); // for date of birth or hire dates
		System.out.println(mat.matches());
